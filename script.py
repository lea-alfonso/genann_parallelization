...
if __name__ == "__main__":
    folder_path = "/home/franco/Documents/Facultad/HPC/genann_parallelization/csv"
    files_in_folder = get_files_in_folder(folder_path)
    print(files_in_folder)
    output_file_path = '/home/franco/Documents/Facultad/HPC/genann_parallelization/training_data/training_data'
